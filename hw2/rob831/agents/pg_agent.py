...
class PGAgent(BaseAgent):
    ...
    def train(self, observations, actions, rewards_list, next_observations, terminals):
        ...
        # self.replay_buffer.add(observations, actions, rewards_list, next_observations, terminals)
        # self.replay_buffer.sample(self.agent_params['batch_size'])
    ...
    def estimate_advantage(self, obs, rewards_list, q_values, terminals):
        ...
        if self.nn_baseline:
            ...
            # q_values = np.squeeze(q_values)  # ensure q_values is 1d array
    ...
    def _discounted_return(self, rewards):
        ...
        T = len(rewards)
        total_return = sum([self.gamma**t * rewards[t] for t in range(T)])
        discounted_returns[:] = total_return
